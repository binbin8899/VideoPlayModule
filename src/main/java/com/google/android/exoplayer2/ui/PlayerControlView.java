...
public class PlayerControlView extends FrameLayout {
     ...
     * The Time bar.
     */
    protected final TimeBar timeBar, landTimeBar;
    private final TextView exo_media_span;//时间分隔
    private final View exo_land_weight;//横屏显示占位空间
    private final TextView videoSwitchText;
    private final TextView videoSelectionText;//选集
    private final TextView exo_speed; //倍速
    private final TextView skip_title;//跳过片头
//    private final ImageView exo_share;//分享H5地址
//    private final ImageView exo_more;//更多
    private final ImageButton exo_next_episode;//下一集
...
//    private final AppCompatCheckBox exoFullscreen;
    ...
    public PlayerControlView(
        ...
        Log.e("PlayerView>>>","PlayerControlView lite");
        ...
        landTimeBar = findViewById(R.id.exo_land_progress);
        exo_media_span = findViewById(R.id.exo_media_span);
        exo_land_weight = findViewById(R.id.exo_land_weight);
        /*我控件布局*/
//        exoFullscreen = findViewById(R.id.exo_video_fullscreen);
        videoSwitchText = findViewById(R.id.exo_video_switch);
        videoSelectionText = findViewById(R.id.exo_video_selection);
        exo_speed = findViewById(R.id.exo_speed);
        skip_title = findViewById(R.id.skip_title);
//        exo_more = findViewById(R.id.exo_more);
//        exo_share = findViewById(R.id.exo_share);
        exo_next_episode = findViewById(R.id.exo_next_episode);
...
//        }
        ...
        if (landTimeBar != null) {
            landTimeBar.addListener(componentListener);
        }
    ...
    private void updateNavigation() {
        ...
        if (landTimeBar != null) {
            landTimeBar.setEnabled(isSeekable);
        }
    ...
    private void updateProgress() {
        ...
        if (player != null) {
            ...
            if (timeBar != null) {
                ...
                if(landTimeBar!=null){
                    landTimeBar.setAdGroupTimesMs(adGroupTimesMs, playedAdGroups, totalAdGroupCount);
                }
            }
        }
        ...
        if (landTimeBar != null) {
            landTimeBar.setPosition(position);
            landTimeBar.setBufferedPosition(bufferedPosition);
            landTimeBar.setDuration(duration);
        }
