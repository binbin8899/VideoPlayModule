...
import com.rlcc.videolibrary.listener.DataSourceListener;
import com.rlcc.videolibrary.listener.ExoPlayerViewListener;
import com.rlcc.videolibrary.listener.ItemVideo;
import com.rlcc.videolibrary.listener.OnCoverMapImageListener;
...
import com.rlcc.videolibrary.listener.VideoInfoListener;
import com.rlcc.videolibrary.listener.VideoWindowListener;
import com.rlcc.videolibrary.utils.ActivityRotationController;
...
public class VideoPlayerManager {
     ...
     * @deprecated Use {@link Builder#enableHintGPRS()} instead.
     */
     ...
     *
     * @param click 实例
     * @deprecated Use {@link Builder#serEnableHintGPRS(boolean)} instead.
     */
    ...
    public static class Builder {
        ...
        public Builder(@PlayerType int type, @NonNull VideoPlayerView view) {
            ...
            if (context instanceof Activity) {
                new ActivityRotationController((Activity) context, mVideoPlayerView);
            }
        }
        ...
        private void initMediaSourceBuilder() {
            if (mediaSourceBuilder == null) {
                try {
                    Class<?> clazz = Class.forName("com.rlcc.videolibrary.whole.WholeMediaSource");
         ...
         * @return
         */
        public Builder setIsAd(boolean isAd) {
            this.isAd = isAd;
            return this;
        }
         ...
         * @return
         */
        public Builder setPLayEpisodeListener(PLayEpisodeListener episodeListener, List<Episode> list){
        ...
        public ExoUserPlayer create() {
            ...
            if (mVideoPlayerView != null) {
                ...
                mVideoPlayerView.setEpisodes(mPLayEpisodeListener,episodes);
                mVideoPlayerView.setIsAd(isAd);
            } else {
