 ...
 * Deprecated: 选集 电视列表
 */
class SelectionView implements View.OnClickListener {
     ...
     */
    public SelectionView(@NonNull Context c, @Nullable List<Episode> listName) {
        this.convertView = View.inflate(c, R.layout.simple_exo_selection, null);
        listView = convertView.findViewById(R.id.list_item);
        adapter = new SelectionAdapter(c, listName);
     ...
     */
    public void showView(@NonNull View view, boolean canceledOnTouchOutside, int selectIndex) {
        if (pw == null) {
                ...
                listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        if (onItemClickListener != null && position != adapter.getSelectIndex()) {
                            onItemClickListener.onItemClick(position, adapter.getItem(position).episode);
                        }
                    }
                });
            }
    ...
    private class ComponentListener implements View.OnClickListener {
        ...
        public void onClick(View view) {
            SelectionView.this.onClick(view);
        }
    }
